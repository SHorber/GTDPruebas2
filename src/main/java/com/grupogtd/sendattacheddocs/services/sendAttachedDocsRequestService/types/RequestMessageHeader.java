  ...
  implements Serializable
{
  ...
  public RequestMessageHeader(String OAPTrxId, String messageTimeStamp) {
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof RequestMessageHeader)) return false; 
    RequestMessageHeader other = (RequestMessageHeader)obj;
  ...
  private static TypeDesc typeDesc = new TypeDesc(RequestMessageHeader.class, true);
  
  static  {
    typeDesc.setXmlType(new QName("http://oap/services/sendAttachedDocsRequestService/types", "RequestMessageHeader"));
